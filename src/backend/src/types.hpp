...
NLOHMANN_JSON_SERIALIZE_ENUM(ImportSource,
                             {
...
inline void from_json(const nlohmann::json &j, SearchQuery &q) {
	if (j.contains("text") && !j.at("text").is_null()) j.at("text").get_to(q.keyword);
	if (j.contains("keyword") && !j.at("keyword").is_null()) j.at("keyword").get_to(q.keyword);
	if (j.contains("tagIds") && !j.at("tagIds").is_null()) j.at("tagIds").get_to(q.tagIds);
	if (j.contains("categoryId") && !j.at("categoryId").is_null()) j.at("categoryId").get_to(q.categoryId);
	if (j.contains("source") && !j.at("source").is_null()) j.at("source").get_to(q.source);
	if (j.contains("timeFrom") && !j.at("timeFrom").is_null()) j.at("timeFrom").get_to(q.timeFrom);
	if (j.contains("timeTo") && !j.at("timeTo").is_null()) j.at("timeTo").get_to(q.timeTo);
	if (j.contains("formats") && !j.at("formats").is_null()) j.at("formats").get_to(q.formats);
	...
	if (j.contains("sortOrder") && !j.at("sortOrder").is_null()) j.at("sortOrder").get_to(q.sortOrder);
	if (j.contains("limit") && !j.at("limit").is_null()) j.at("limit").get_to(q.limit);
	if (j.contains("offset") && !j.at("offset").is_null()) j.at("offset").get_to(q.offset);
	if (j.contains("include_tags") && !j.at("include_tags").is_null()) j.at("include_tags").get_to(q.includeTags);
	if (j.contains("includeTags") && !j.at("includeTags").is_null()) j.at("includeTags").get_to(q.includeTags);
}
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE_WITH_DEFAULT(ImportTask,
                                                taskId,
                                                source,
                                                inputs,
                                                status,
...
NLOHMANN_JSON_SERIALIZE_ENUM(PipelineStage,
                             {
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE_WITH_DEFAULT(ImportPipeline,
                                                taskId,
                                                inputPath,
                                                destPath,
                                                fileHash,
