...
export function PlusButton({ active, className, ...props }: PlusButtonProps) {
    return (
        <button
            className={twMerge(
                clsx(
                    "w-7 h-7 rounded-full bg-accent text-white flex items-center justify-center transition-all duration-200 ease-out no-drag shadow-md",
